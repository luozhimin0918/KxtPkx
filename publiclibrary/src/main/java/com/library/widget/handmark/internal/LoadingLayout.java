...
import com.library.widget.handmark.ILoadingLayout;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout
{
	...
	protected final ProgressWheel mHeaderProgress;
	...
	private CharSequence mPullLabel2;
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
		...
		switch (mode) {
			case PULL_FROM_END:
				...
				mPullLabel2 = context.getString(R.string.pull_to_refresh_pull_label2);
	...
	public final void pullToRefresh() {
		if (null != mHeaderText) {
			switch (mMode) {
				case PULL_FROM_END:
					mHeaderText.setText(mPullLabel2);
					break;
				case PULL_FROM_START:
