...
package com.library.widget.swipyrefreshlayout;
...
public class SwipyRefreshLayout extends ViewGroup
{
    ...
    public SwipyRefreshLayout(Context context, AttributeSet attrs)
    {
        ...
        direction = SwipyRefreshLayoutDirection.getFromInt(a2.getInt(R.styleable.SwipyRefreshLayout_direction, 0));
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        if (!mUsingCustomStart && !mOriginalOffsetCalculated)
        {
            ...
            {
                case BOTTOM:
                    mCurrentTargetOffsetTop = mOriginalOffsetTop = getMeasuredHeight() - mCircleView
                            .getMeasuredHeight();
                    break;
                case TOP:
                default:
