package com.library.widget.datetimepicker.sleepbot.datetimepicker.time;
    ...
    public void setCurrentItemShowing(int index, boolean animate) {
        ...
        if (animate && (index != lastIndex)) {
            ...
            if (Build.VERSION.SDK_INT >= 11) {
                float hourAlpha = (float) ((index == HOUR_INDEX) ? 1.0 : 0.0);
                float minuteAlpha = (float) ((index == MINUTE_INDEX) ? 1.0 : 0.0);
