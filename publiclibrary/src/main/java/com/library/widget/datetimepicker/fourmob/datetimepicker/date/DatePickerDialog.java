...
import com.library.widget.datetimepicker.fourmob.datetimepicker.Utils;
...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController
{
    ...
    private void updateDisplay(boolean announce)
    {
        ...
        if (this.mDayOfWeekView != null)
        {
            ...
            this.mDayOfWeekView.setText(mDateFormatSymbols.getWeekdays()[this.mCalendar.get(Calendar.DAY_OF_WEEK)]
                    .toUpperCase(Locale.getDefault()));
        }

        this.mSelectedMonthTextView.setText(mDateFormatSymbols.getMonths()[this.mCalendar.get(Calendar.MONTH)]
                .toUpperCase(Locale.getDefault()));
//        this.mSelectedMonthTextView.setText(DateTimeUtil.getMonths(this.mCalendar.get(Calendar.MONTH)));
...
//        getDialog().getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.date_picker_title);
    }
...
//        getDialog().requestWindowFeature(Window.FEATURE_CUSTOM_TITLE);
    ...
    private void onDoneButtonClick()
    {
        ...
        if (mCallBack != null)
        {
            mCallBack.onDateSet(this, mCalendar.get(Calendar.YEAR), mCalendar.get(Calendar.MONTH) + 1, mCalendar.get
