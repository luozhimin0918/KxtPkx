...
public class SimpleMonthView extends View {
	...
	private void drawMonthDayLabels(Canvas canvas) {
        ...
        for (int i = 0; i < mNumDays; i++) {
            ...
            canvas.drawText(DateTimeUtil.getWeekdays(mDayLabelCalendar.get(Calendar.DAY_OF_WEEK)), x, y, mMonthDayLabelPaint);
        }
	}
...
//        canvas.drawText(getMonthAndYearString(), x, y, mMonthTitlePaint);
        String timeInMillisToMonths = DateTimeUtil.getTimeInMillisToMonths(mCalendar.getTimeInMillis());
        canvas.drawText(timeInMillisToMonths, x, y, mMonthTitlePaint);
	}
	...
	protected void drawMonthNums(Canvas canvas) {
		...
		while (day <= mNumCells) {
            ...
            if (mHasToday && (mToday == day)) {
                ...
                mMonthNumPaint.setTextSize(SystemUtil.dp2px(getContext(),12));
                canvas.drawText("今天", x, y, mMonthNumPaint);
            } else {
				mMonthNumPaint.setColor(mDayTextColor);
                mMonthNumPaint.setTextSize(SystemUtil.dp2px(getContext(),18));
