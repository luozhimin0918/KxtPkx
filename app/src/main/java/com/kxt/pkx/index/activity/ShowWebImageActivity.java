...
public class ShowWebImageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onLoadingFailed(String imageUri, View view,
                        ...
                        imageView
                                .setImageBitmap(((BitmapDrawable) getResources()
                                        .getDrawable(R.mipmap.ico_def_load))
                                        .getBitmap());
                    }
        ...
        imageView.setOnImageTouchedListener(new ZoomableImageView.OnImageTouchedListener() {
    ...
    private class SaveImage extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ToastView.makeText3(ShowWebImageActivity.this, result);
        }
    }
}
